...
print("First :", risk_scores[???])   # index 0
print("Last  :", risk_scores[???])   # last item using negative index
print("Count :", ???(risk_scores))   # number of items`,
      hints: [
...
for s in scores_to_add:
    feed.???(s)            # add each score to the list
