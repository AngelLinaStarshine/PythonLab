...
# <class 'float'> is the type of: ???
# <class 'bool'>  is the type of: ???`,
      hints: [
        ...
        "Replace each ??? with the variable name whose type you want to check.",
      ],
...
print(f"2FA      : {???}")`,
      hints: [
        ...
        "Replace each ??? with the variable name that belongs on that line.",
      ],
