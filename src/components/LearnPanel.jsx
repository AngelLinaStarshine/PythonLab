    ...
    >
      ...
      >
        <span style={{ color: C.t2 }}>
          {done ? "‚?? Reading complete" : `‚è± Minimum read time, ${formatTime(remaining)} remaining`}
        </span>
    ...
    <div className="learn-panel learn-panel-tabbed">
      ...
      >
        ...
        >
          ...
          <span style={{ fontSize: 12, color: C.t3 }}>{open ? "‚?≤" : "‚?º"}</span>
        </div>
            ...
            {activeTab === "read" && (
              <>
                {lesson?.concept && (
                  ...
                  >
                    <strong style={{ color: C.cyan }}>??Ø Concept: </strong>
                    {lesson.concept}
                  </div>
                )}
