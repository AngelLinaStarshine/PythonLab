    ...
    <div style={{fontSize:13, color:C.t2, lineHeight:1.7}}>
      ...
      <Section icon="🤖" title="ARIA. Your AI Study Assistant" color={C.purple}>
        ...
        <Step n={3} title="How to use ARIA"
          body="Read her message, click the blue Reread button to jump back to the relevant section, then try again. You can minimise ARIA and keep working."/>
        <TipBox>ARIA is not a shortcut. she points you to the reading, not the answer. Rereading the highlighted section is the fastest route to passing.</TipBox>
      </Section>
  ...
  const tools = [
    {
      ...
      howTo:[
        ...
        "Click + New Notebook. Upload your lesson PDFs, paste the lesson text, or paste docs/NOTEBOOKLM_MASTER_PROMPT.md from this repo as your first source.",
          ...
          >
            ...
            <div style={{
              ...
              <span style={{fontSize:11, color:C.t3}}>
                Cyber/AI Python Lab · Ontario Grade 10 to 11
              </span>
              <button onClick={()=>setOpen(false)} style={{...btn(),
